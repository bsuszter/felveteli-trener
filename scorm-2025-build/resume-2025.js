(() => {
  ...
  // Save whenever a question is rendered or its score/progress changes.
  // The latter also preserves text typed into fill-in tasks before navigation.
  ...
  if (!saved || saved.module !== "2025" || !Array.isArray(saved.answers)) return;
